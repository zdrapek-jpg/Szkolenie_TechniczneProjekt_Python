...
assert(find_file('Tests.py','C:\Program Files\Pulpit\Projekt_Python\\'))==  "C:\Program Files\Pulpit\Projekt_Python\Tests.py"
assert(find_dir('OCR_Model','C:\Program Files\Pulpit\Projekt_Python\\'))==  "C:\Program Files\Pulpit\Projekt_Python\OCR_Model"
assert(find_dir('Images','C:\Program Files\Pulpit\Projekt_Python\\'))==  "C:\Program Files\Pulpit\Projekt_Python\Images"
assert(find_dir('Output_Images','C:\Program Files\Pulpit\Projekt_Python\\'))==  "C:\Program Files\Pulpit\Projekt_Python\Output_Images"
assert(find_file("paragon6.jpg",'C:\Program Files\Pulpit\Projekt_Python\\'))=="C:\Program Files\Pulpit\Projekt_Python\Paragons\paragon6.jpg"
assert(find_file('mymodel_retrained.h5','C:\Program Files\Pulpit\Projekt_Python\\'))=="C:\Program Files\Pulpit\Projekt_Python\OCR_Model\mymodel_retrained.h5"
