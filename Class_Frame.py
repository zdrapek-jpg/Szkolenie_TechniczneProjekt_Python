...
class Frame_Ocr(ttk.Frame):
    def __init__(self, parent, input_label_name, errors_name, button_name, at=False, errors_name_model=None):
        ...
        ttk.Button(self, text=button_name, command=self.process_Image_before).pack(pady=10, padx=10)
